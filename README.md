...
To extract the raw binary blocks from your SD card and convert them into a clean CSV file as described in the technical report, use the provided Python utility:
